...
### Motivation
I remember when I was a wee middle schooler and first heard about the Nader/Gore fiasco, my immediate reaction was "why the hell don't we have a ranked-order voting system!?!"

Almost a decade later, now that I am studying social choice and decision theory, I finally have an answer for my middle school self: Kenneth Arrow's Impossiblity Theorem.

Formally, the theorem states that _no_ rank-order voting system with more than 2 candidates can satisfy unanimity, binary independence, and non-dictatorship simultaneously.

Middle school Siddharth: "What the hell do I care about unanimity? Binary independence? How could there be a dictator if it's a democracy!?"

Oh silly Sidhu, let me explain...
...
Make sense now Sidhu?

Middle school Siddharth: "No but I guess I believe you..."

Yah, me too lol. 

I would classify Arrow's Impossibility Theorem as _deeply_ counter-intuitive, but it is one of the hallmarks of social choice theory. 

The essence of the theorem is that there is no 'right' way to aggregate opinions, and while that might sound dismal (bum dum tss), it also means that normative considerations are _inevitable_ when we choose how to pool together people's beliefs and tastes. 

Don't get me wrong; the theorem is drop dead gorgeous. However, I suspect the Nobel Prize commitee's decision to grant Arrow his award in 1972 was not primarily motivated by the result's beauty, but rather, its damning revelation of the fundamentally human nature of economics. 