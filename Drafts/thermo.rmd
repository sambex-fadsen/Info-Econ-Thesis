...
In general, if the amount of each security sold changes from $\vec{q}$ to $\vec{q}'$ then the change in free energy of our prediction market (or the amount of money it gives out in the transaction) is:
...
and the average work performed on the market (or the expected number of paying shares the market bought) is:
$$\overline{W}=\sum_{i=1}^N-(q'_i-q_i)\cdot p_i(\vec{q})$$
We wish to show:
...
\begin{align*}
& b \cdot \ln\left(\frac{\sum_{i=1}^N e^{q_i/b}}{\sum_{i=1}^N e^{q_i'/b}}\right) \leq \sum_{i=1}^N-(q'_i-q_i)\cdot p_i(\vec{q})
\\
& \iff b \cdot \ln\left(\frac{\sum_{i=1}^N e^{q_i/b}}{\sum_{i=1}^N e^{q_i'/b}}\right) \leq \sum_{i=1}^N-(q'_i-q_i)\cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}
\\
& \iff \frac{\sum_{i=1}^N e^{q_i/b}}{\sum_{i=1}^N e^{q_i'/b}} \leq \frac{e^{q_i/b \cdot  \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}
\\
& \iff \frac{\sum_{i=1}^N e^{q_i/b}}{e^{q_i/b \cdot  \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}\leq \frac{\sum_{i=1}^N e^{q_i'/b}}{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}
\end{align*}
Indeed, since $\frac{\sum_{i=1}^N e^{q_i'/b}}{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}$ is a convex function of $\vec{q}'$ and setting:
\begin{align*}
\frac{\partial}{\partial q'_k}\left(\frac{\sum_{i=1}^N e^{q_i'/b}}{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}\right)&=\frac{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}} \cdot e^{q'_k/b}-e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}} \cdot \frac{e^{q_k/b}}{\sum_{i}e^{q_i/b}} \cdot \sum_{i}e^{q'_i/b}}{\left(e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}\right)^2}
\\
&=\frac{e^{q'_k/b}-\frac{e^{q_k/b}}{\sum_{i}e^{q_i/b}} \cdot \sum_{i}e^{q'_i/b}}{e^{q'_i/b \cdot \frac{e^{q_i/b}}{\sum_{i=1}^N e^{q_i/b}}}}=0
\end{align*}
yields:
$$\frac{e^{q'_k/b}}{\sum_{i} e^{q'_i/b}}=\frac{e^{q_k/b}}{\sum_{i} e^{q_i/b}}$$
we know that $\vec{q}'=\vec{q}$ is a global minimum of our function.
