...
This also allows us to immediately conclude that the money given out by the market at any given point in time is bounded above by average number of shares sold to the market for each security $i$ since by Jensen's:
\begin{align*}
...
\\
&=b \cdot \ln\left(\frac{\sum_{i=1}^N e^{q_i}}{\sum_{i=1}^N e^{q_i'}}\right)
\end{align*}
...
\\
&=b \cdot \ln\left(\frac{\sum_{i=1}^N e^{q_i}}{\sum_{i=1}^N e^{q_i'}}\right)-b \cdot KL(\text{Pr}_{\text{trader}} \ || \ \text{Pr}_{\text{AMM}})
\end{align*}
...
\\
&=b \cdot \ln\left(\frac{\sum_{i=1}^N e^{q_i}}{\sum_{i=1}^N e^{q_i'}}\right)+\left(b \cdot KL(\text{Pr}_{\text{trader}} \ || \ \text{Pr}_{\text{participant}})-b \cdot KL(\text{Pr}_{\text{trader}} \ || \ \text{Pr}_{\text{AMM}})\right)
\end{align*}
