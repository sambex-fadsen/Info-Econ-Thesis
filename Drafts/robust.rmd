...
\begin{align*}
b\cdot KL(\mathbb{P}_S,\mathbb{P}'_S)&= \sum_{n}b\cdot\mathbb{P}(S=s_n)\ln\left(\frac{\mathbb{P}(S=s_n)}{\mathbb{P}'(S=s_n)}\right)
\\
&=\sum_{n}b\cdot\mathbb{P}(S=s_n)\ln\left(\frac{1}{\mathbb{P}'(S=s_n)}\right)-\sum_{n}b\cdot\mathbb{P}(S=s_n)\ln\left(\frac{1}{\mathbb{P}(S=s_n)}\right)
\\
&=\sum_{n}b\cdot\mathbb{P}(S=s_n)\ln\left(\frac{1}{\mathbb{P}'(S=s_n)}\right)-H(S)
\end{align*}
